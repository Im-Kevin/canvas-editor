...
class Position {
  ...
  getPositionByXY(payload) {
    ...
    if (!isLastArea) {
      ...
      return {
        index: ((_b = lastLetterList[lastLetterList.length - 1]) == null ? void 0 : _b.index) || positionList.length - 1
      };
    }
    return {
      hitLineStartIndex,
...
class ListParticle {
  constructor(draw) {
    ...
    this.DEFAULT_DRAWDISC_WIDTH = 20;
  ...
  setList(listType, listStyle, iconPaddingLeft, iconSize) {
    const isReadonly = this.draw.isReadonly();
    if (isReadonly)
      return;
    const { startIndex, endIndex } = this.range.getRange();
    ...
    changeElementList.forEach((el) => {
      ...
      el.iconSize = (_a = iconSize != null ? iconSize : el.iconSize) != null ? _a : 0;
      el.iconPaddingLeft = (_b = iconPaddingLeft != null ? iconPaddingLeft : el.iconPaddingLeft) != null ? _b : 0;
    });
  ...
  getListStyleWidth(ctx, listElementList) {
    ...
    const iconPaddingLeft = (_a = startElement.iconPaddingLeft) != null ? _a : 0;
    if (startElement.listStyle && startElement.listStyle !== ListStyle.DECIMAL) {
      if (startElement.listStyle === ListStyle.CHECKBOX) {
        ...
        return (((_b = startElement.iconSize) != null ? _b : this.DEFAULT_DRAWDISC_WIDTH) + iconPaddingLeft) * scale;
      }
  ...
  drawListStyle(ctx, row, position) {
    ...
    const x = startX - offsetX + tabWidth + ((_a = startElement.iconPaddingLeft) != null ? _a : 0);
    ...
    if (startElement.listStyle === ListStyle.CHECKBOX) {
      ...
      const checkboxRowElement = {
        ...startElement,
        checkbox: {
          value: !!((_b = startElement.checkbox) == null ? void 0 : _b.value)
        },
        metrics: {
      ...
      ctx.save();
      const iconSize = (_c = startElement.iconSize) != null ? _c : this.DEFAULT_DRAWDISC_WIDTH;
    ...
    if (deleteCount > 0) {
      ...
      if (!this.control.getActiveControl()) {
        ...
        while (deleteIndex >= start) {
          if (((_b = elementList[deleteIndex].control) == null ? void 0 : _b.deletable) !== false) {
...
class CommandAdapt {
  ...
  list(listType, listStyle, iconPaddingLeft, iconSize) {
    const isReadonly = this.draw.isReadonly();
    if (isReadonly)
      return;
